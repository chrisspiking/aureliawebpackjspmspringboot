...
// Source: https://raw.githubusercontent.com/aurelia/binding/master/dist/aurelia-binding.d.ts
 ...
 */
export interface ICollectionObserverSplice<T = any> {
 ...
 */
export class ValueAttributeObserver implements InternalPropertyObserver {
 ...
 */
export class CheckedObserver implements InternalPropertyObserver {
 ...
 */
export class SelectValueObserver implements InternalPropertyObserver {
 ...
 */
export class DirtyCheckProperty implements InternalPropertyObserver {
  /**
   * Gets the property value.
   */
  getValue(): any;
 ...
 * A factory for binding instances.
 */
export interface ListenerExpression {
  createBinding(target: any): Binding;
}
 ...
 */
export const targetContext: string;
...
*/
export function connectable(): void;
 ...
 */
export function connectBindingToSignal(binding: Binding, name: string): void;
 ...
 */
export function signalBindings(name: string): void;
}
