...
// Source: https://raw.githubusercontent.com/aurelia/http-client/master/dist/aurelia-http-client.d.ts
...
* @param xhr The xhr instance.
*/
export function downloadProgressTransformer(client: HttpClient, processor: RequestMessageProcessor, message: RequestMessage, xhr: XHR): any;
